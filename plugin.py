...
def beet_default(ctx: Context):
    ...
    other = Rhombus.constant(5)
    d = Rhombus.constant(1) + Rhombus.ExternalDensity(other)
    print(d)
    d.inject(data, "a:function", log=False)

    print(Rhombus.Density.from_datapack(data, "a:function"))